...
@Autonomous (name = "Roadrunner REED Freight", group = "Autonomous Main")
public class Red_Freight extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory Place1 = drive.trajectoryBuilder(startPose)
                .splineToConstantHeading(new Vector2d(-2, -52), Math.toRadians(180))
                .build();
        ...
        Trajectory Park1 = drive.trajectoryBuilder(Duck1.end())
                .splineToConstantHeading(new Vector2d(-62, -42), Math.toRadians(0))
                .build();
        ...
        Trajectory Park2 = drive.trajectoryBuilder(Duck2.end())
                .splineToConstantHeading(new Vector2d(-64, -40), Math.toRadians(0))
                .build();

        //Bottom
        Trajectory Place3 = drive.trajectoryBuilder(startPose)
                .splineToConstantHeading(new Vector2d(-4, -52), Math.toRadians(180))
                .build();
        ...
        Trajectory Park3 = drive.trajectoryBuilder(Duck2.end())
                .splineToConstantHeading(new Vector2d(-62, -40), Math.toRadians(0))
                .build();
